...
describe('RestrauntModal Consolidation', () => {
  ...
  describe('Create Mode', () => {
    ...
    test('should call postRestraunt on submit', async () => {
      postRestraunt.mockResolvedValue({ restraunts: { id: 2, name: 'New' }, user_name: 'User' });
      postTagsTaggedItem.mockResolvedValue({ tags_tagged_item: {} });
  ...
  describe('Edit Mode', () => {
    ...
    test('should call updateRestraunt on submit', async () => {
      updateRestraunt.mockResolvedValue({ restraunts: { ...mockRestaurant, name: 'Updated' } });
